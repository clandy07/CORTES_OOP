...
public class CommissionEmployee {
    ...
    public void displayInfo() {
        System.out.printf("You have accumulated a total of Php %.2f which means you have %s for this quarter. Your total salary after further computation is: Php %.2f", totalSales, saleType, salary);
    }
