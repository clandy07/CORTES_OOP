...
public class PieceWorkerEmployee {
    ...
    public double computeSalary() {
        if(this.totalPiecesFinished < 100) {
           ...
           this.temp = this.totalPiecesFinished / 100;
           this.retVal = (this.totalPiecesFinished * this.ratePerPiece) + (this.temp * (this.ratePerPiece * 10));
    ...
    public void displayInfo() {
        System.out.printf("Pieces finished: %d\nRate per piece: Php %.2f\nTotal income: Php %.2f",totalPiecesFinished,ratePerPiece,retVal);
    }
